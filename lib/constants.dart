...
const TextStyle tahinaStyleNormal2 = TextStyle(fontSize: 20, fontFamily: "Tihana", fontWeight: FontWeight.normal);

const TextStyle KTSR3StyleSmall1 = TextStyle(fontSize: 16, fontFamily: "KTSR3", fontWeight: FontWeight.bold);

const TextStyle KTSR3StyleSmall2 = TextStyle(fontSize: 16, fontFamily: "KTSR3", fontWeight: FontWeight.normal);